...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615ee' => 'get1Bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615eeService',
            '2_bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615ee' => 'get2Bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615eeService',
            ...
            'security.authentication.provider.anonymous.usuarios' => 'getSecurity_Authentication_Provider_Anonymous_UsuariosService',
            'security.authentication.provider.dao.admin' => 'getSecurity_Authentication_Provider_Dao_AdminService',
            'security.authentication.provider.dao.usuarios' => 'getSecurity_Authentication_Provider_Dao_UsuariosService',
        ...
        $this->privates = array(
            '1_bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615ee' => true,
            '2_bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615ee' => true,
            ...
            'security.authentication.provider.anonymous.usuarios' => true,
            'security.authentication.provider.dao.admin' => true,
            'security.authentication.provider.dao.usuarios' => true,
            ...
            'security.user.provider.concrete.my_db_provider' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615ee']) ? $this->services['1_bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615ee'] : $this->get1Bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615eeService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615ee']) ? $this->services['2_bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615ee'] : $this->get2Bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615eeService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\BorjaBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\EsqueletoBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'BorjaBundle\\Entity');
        $c->addDriver($b, 'EsqueletoBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('BorjaBundle' => 'BorjaBundle\\Entity', 'EsqueletoBundle' => 'EsqueletoBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_9942d03386749a976f9c2535496954bdadb93acb89cf63097a9f4bc82c8d2b22');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('EsqueletoBundle\\Entity\\Login' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    /**
     * Gets the public 'security.firewall.map.context.usuarios' shared service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext
     */
    protected function getSecurity_Firewall_Map_Context_UsuariosService()
    {
        ...
        $h = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, '/usuario/login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/usuario/logout'));
        ...
        $i->setOptions(array('login_path' => '/usuario/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $i->setProviderKey('usuarios');

        $j = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $e, array(), $b);
        $j->setOptions(array('login_path' => '/usuario/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.usuarios'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => ${($_ = isset($this->services['security.channel_listener']) ? $this->services['security.channel_listener'] : $this->getSecurity_ChannelListenerService()) && false ?: '_'}, 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => ${($_ = isset($this->services['security.user.provider.concrete.in_memory']) ? $this->services['security.user.provider.concrete.in_memory'] : $this->getSecurity_User_Provider_Concrete_InMemoryService()) && false ?: '_'}, 1 => ${($_ = isset($this->services['security.user.provider.concrete.my_db_provider']) ? $this->services['security.user.provider.concrete.my_db_provider'] : $this->getSecurity_User_Provider_Concrete_MyDbProviderService()) && false ?: '_'}), 'usuarios', $b, $c, $d), 2 => $h, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $e, 'usuarios', $i, $j, array('check_path' => '/usuario/login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5a72f37c3a2b46.74669873', $b, $g), 5 => ${($_ = isset($this->services['security.access_listener']) ? $this->services['security.access_listener'] : $this->getSecurity_AccessListenerService()) && false ?: '_'}), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $d, $e, 'usuarios', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, '/usuario/login', false), NULL, NULL, $b, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('usuarios', 'security.user_checker', 'security.request_matcher.a64d671f18e5575531d76c1d1154fdc4476cb8a79c02ed7a3469178c6d7b96b5ed4e60db', true, false, 'security.user.provider.concrete.my_db_provider', 'usuarios', 'security.authentication.form_entry_point.usuarios', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'anonymous')));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\BorjaBundle/Resources/views'), 'Borja');
        $instance->addPath(($this->targetDirs[3].'\\src\\EsqueletoBundle/Resources/views'), 'Esqueleto');
    ...
    /**
     * Gets the private '1_bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615ee' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get1Bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615eeService()
    {
        return $this->services['1_bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615ee'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615ee' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get2Bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615eeService()
    {
        return $this->services['2_bc2a907609e51c8c7ca1e2aed80af1991ebd5578540efe9792804bfee66615ee'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('FqIBsnBfmX', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UyyHTmdoV4', 0, 'iTXmy8JUiZfiSTlNEOYsIH', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('41Weh8vBlA', 0, 'iTXmy8JUiZfiSTlNEOYsIH', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sqY0wJ-pVx', 0, 'iTXmy8JUiZfiSTlNEOYsIH', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuario/crud'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/paco/crud'), array(0 => 'ROLE_ADMIN'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['security.authentication.provider.dao.usuarios']) ? $this->services['security.authentication.provider.dao.usuarios'] : $this->getSecurity_Authentication_Provider_Dao_UsuariosService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['security.authentication.provider.anonymous.usuarios']) ? $this->services['security.authentication.provider.anonymous.usuarios'] : $this->getSecurity_Authentication_Provider_Anonymous_UsuariosService()) && false ?: '_'};
            yield 2 => ${($_ = isset($this->services['security.authentication.provider.dao.admin']) ? $this->services['security.authentication.provider.dao.admin'] : $this->getSecurity_Authentication_Provider_Dao_AdminService()) && false ?: '_'};
        }, 3), true);
    ...
    /**
     * Gets the private 'security.authentication.provider.anonymous.usuarios' shared service.
     *
     * @return \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider
     */
    protected function getSecurity_Authentication_Provider_Anonymous_UsuariosService()
    {
        return $this->services['security.authentication.provider.anonymous.usuarios'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a72f37c3a2b46.74669873');
    }
    ...
    /**
     * Gets the private 'security.authentication.provider.dao.usuarios' shared service.
     *
     * @return \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider
     */
    protected function getSecurity_Authentication_Provider_Dao_UsuariosService()
    {
        return $this->services['security.authentication.provider.dao.usuarios'] = new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider(${($_ = isset($this->services['security.user.provider.concrete.my_db_provider']) ? $this->services['security.user.provider.concrete.my_db_provider'] : $this->getSecurity_User_Provider_Concrete_MyDbProviderService()) && false ?: '_'}, ${($_ = isset($this->services['security.user_checker']) ? $this->services['security.user_checker'] : $this->getSecurity_UserCheckerService()) && false ?: '_'}, 'usuarios', ${($_ = isset($this->services['security.encoder_factory']) ? $this->services['security.encoder_factory'] : $this->get('security.encoder_factory')) && false ?: '_'}, true);
    }
    ...
    protected function getSecurity_Firewall_MapService()
    {
        ...
        }, 'security.firewall.map.context.usuarios' => function () {
            return ${($_ = isset($this->services['security.firewall.map.context.usuarios']) ? $this->services['security.firewall.map.context.usuarios'] : $this->get('security.firewall.map.context.usuarios')) && false ?: '_'};
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('usuarios', '/usuario/logout', 'logout', '_csrf_token', NULL, NULL);
    ...
    {
        return $this->services['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(array('admin' => array('password' => 'abc', 'roles' => array(0 => 'ROLE_ADMIN'))));
    }

    /**
     * Gets the private 'security.user.provider.concrete.my_db_provider' shared service.
     *
     * @return \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider
     */
    protected function getSecurity_User_Provider_Concrete_MyDbProviderService()
    {
        return $this->services['security.user.provider.concrete.my_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->get('doctrine')) && false ?: '_'}, 'EsqueletoBundle:Login', 'username', NULL);
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'BorjaBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\BorjaBundle'),
                    'namespace' => 'BorjaBundle',
                ),
                'EsqueletoBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\EsqueletoBundle'),
                    'namespace' => 'EsqueletoBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BorjaBundle' => 'BorjaBundle\\BorjaBundle',
                'EsqueletoBundle' => 'EsqueletoBundle\\EsqueletoBundle',
